...
const DemoGallery: React.FC = () => {
    ...
    const applyLayout = (persona: DemoPersona) => {
        // Store the selected layout preference
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <div className="flex items-center gap-2 bg-background/50 backdrop-blur-sm rounded-xl p-1">
                                    <button
                                        ...
                                        className={`p-2 rounded-lg transition-all ${devicePreview === 'desktop' ? 'bg-card shadow-sm' : 'text-muted-foreground'}`}
                                    >
                                        <Monitor size={18} />
                                    </button>
                                    <button
                                        onClick={() => setDevicePreview('tablet')}
                                        className={`p-2 rounded-lg transition-all ${devicePreview === 'tablet' ? 'bg-card shadow-sm' : 'text-muted-foreground'}`}
                                    >
                                        <Tablet size={18} />
                                    </button>
                                    <button
                                        onClick={() => setDevicePreview('phone')}
                                        className={`p-2 rounded-lg transition-all ${devicePreview === 'phone' ? 'bg-card shadow-sm' : 'text-muted-foreground'}`}
                                    >
                                        <Smartphone size={18} />
                                    </button>
                                </div>
